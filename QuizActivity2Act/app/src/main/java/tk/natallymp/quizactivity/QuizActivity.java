...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"onCreate(Bundle) called in QuizActivity");
        ...
        // получаем значение mCurrentIndex предыдущего экземпляра QuizActivity,
        // уничтоженного при повороте телефона
